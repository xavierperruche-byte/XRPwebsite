...
carouselImages:
  - src: '/images/thalie2.webp'
    alt: 'Thalie Paris'
    caption: 'Thalie Paris'
  - src: '/images/thalie3.webp'
    alt: 'Thalie Paris'
    caption: 'Thalie Paris'
  - src: '/images/thalie4.webp'
    alt: 'Thalie Paris'
    caption: 'Thalie Paris'
  - src: '/images/thalie5.webp'
    alt: 'Thalie Paris'
    caption: 'Thalie Paris'
  - src: '/images/thalie6.webp'
    alt: 'Thalie Paris'
    caption: 'Thalie Paris'
...
# Thalie, une muse par qui la nature refleurit.

<b>Un univers joyeux de chapeaux personnalisables aux couleurs chatoyantes !</b>

Sur le balcon ensoleillé de l’hôtel, surplombant le lac, je retrouve Nathalie Dionne, la fondatrice de Thalie Paris.

Une première rencontre sous les meilleurs auspices.

Je découvre enfin Thalie Paris : les sacs sont là, luxueux et lumineux, brillants de leur cuir de saumon, ou de cactus, cuirs recyclés au style parisien branché, ultra sophistiqué, mais tellement irrésistible.
...
Cloitrée dans son appartement du 16è arrondissement, Nathalie Dionne pense qu’il est grand temps de réaliser ce rêve qui l’habite depuis un certain temps : lancer une maison de haute maroquinerie. Alors qu’elle déambule vers le Palais de Tokyo, son regard se dirige vers ce mot Thalie écrit sur un bas-relief des années 30 du sculpteur français Janniot. Une énigme, qui s’avère être une révélation.

L’esthétique de la marque s’inspire de l’art moderne des années 30, de Paris 16è et des Parisiens mystérieux qui ont inspiré la photographie de mode et l’art à travers l’histoire, comme la mécène Marie-Laure de Noailles au “bal de la mer” portant une robe en cuir marin ou une série d’images d’Helmut Newton prises à la fin des années 70 dans le 16è arr. de Paris.
...
La collection Sushi de Thalie propose des sacs produits à partir du recyclage industriel de peaux de saumon provenant de restaurants de sushis en France. La collection Sushi est réalisée en cuir Squama ; ce cuir marin est développé par ICTYOS – une startup incubée à la Maison des Start-ups LVMH. Les modèles emblématiques, Livia, Cléo et Raphaëlle, sont entièrement fabriqués en France, ce qui réduit fortement l’empreinte carbone.
...
Merci à Oksana Cantelmo instagram @miss_cantelmo pour ces photos.</div>
